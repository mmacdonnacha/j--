...
class JShiftRightOp extends JBinaryExpression {
    ...
    /**
     * Constructs an AST for a Shift Right expression given its line number,
     * and the lhs and rhs operands.
     * 
     * @param line
     *            line in which the division expression occurs in the
...
class JShiftLeftOp extends JBinaryExpression {
    ...
    /**
     * Constructs an AST for a Shift Left expression given its line number,
     * and the lhs and rhs operands.
     * 
     * @param line
     *            line in which the division expression occurs in the
...
class JShiftRightUnsignedOp extends JBinaryExpression {

    /**
     * Constructs an AST for a Logical Shift Right expression given its line number,
     * and the lhs and rhs operands.
     * 
     * @param line
     *            line in which the division expression occurs in the
    ...
    public JShiftRightUnsignedOp(int line, JExpression lhs, JExpression rhs) {
        super(line, ">>>", lhs, rhs);
    }
